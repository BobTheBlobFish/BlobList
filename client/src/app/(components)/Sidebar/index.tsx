...
{showPriority && (
  <>
    ...
    <SidebarLink icon={Layers3} label="Backlog" href="/teams" />
  </>
)}
...
return (
  <Link href={href} className="w-full">
    <div className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-black ${isActive ? 'bg-gray-100 dark:bg-gray-600' : ''} justify-start px-7 py-3`}>
      {isActive && (
